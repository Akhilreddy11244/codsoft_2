...
btn_clear = Button(mw, text='clear', padx=74, pady=10, font=('Arial',14),command=clearn)
btn_div = Button(mw, text='/', padx=38, pady=10, font=('Arial',14),command=lambda:data('div'))
btn_mul = Button(mw, text='*', padx=38, pady=10, font=('Arial',14),command=lambda:data('mul'))
btn_add = Button(mw, text='+', padx=36, pady=10, font=('Arial',14),command=lambda:data('add'))
btn_sub = Button(mw, text='-', padx=38, pady=10, font=('Arial',14),command=lambda:data('sub'))
